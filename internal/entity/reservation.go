...
type Reservation struct {
	...
	ReservationDate string `db:"reservation_date"` // El formato de este date es ISO 8601. Para tener mas control sobre la fecha podriamos cambiar el tipo de dato a time.Time (en vez de string)
}
